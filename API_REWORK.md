...
**Recording is deferred.** `dasImgui` has stbimage; if external tools (OBS, Windows Game Bar, ffmpeg screen capture) prove inadequate, fall back to PNG-sequence dump from the FBO. Not v1.
