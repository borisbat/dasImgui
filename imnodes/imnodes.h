...
struct ImNodesIO
{
    struct EmulateThreeButtonMouseStruct // MODIFIED BY GAIJIN: added a Struct postfix because of the code generator
    {
        EmulateThreeButtonMouseStruct();
    ...
    struct LinkDetachWithModifierClickStruct // MODIFIED BY GAIJIN: added a Struct postfix because of the code generator
    {
        LinkDetachWithModifierClickStruct();
